...
module.exports = React.createClass( {
	...
	renderThemes: function() {
		return (
			<div>
				<div>
					<h2 className="mlb-theme-selection__header">{ this.translate( 'Your team' ) }</h2>
				...
				<h2 className="mlb-theme-selection__header">{ this.translate( 'Theme' ) }</h2>
				...
				<div className="mlb-theme-selection__terms">
					<h2 className="mlb-theme-selection__header">{ this.translate( 'MLB.com/blogs Rules' ) } </h2>
					<p>
